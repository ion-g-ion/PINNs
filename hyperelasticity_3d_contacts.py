...
class Pinn(pinns.PINN):
    ...
    def loss(self, training_parameters, points):
        ...
        # contacts 
        contact_res = jnp.dot(pinns.geometry.gap_to_convex_polytope(self.Ab[0], self.Ab[1], points['ds3'].points_physical+self.solutions['obj3'](training_parameters, points['ds3'].points_reference)), points['ds3'].weights)
...
if opt_type == 'ADAM':
    ...
    def step(params, opt_state, key):
        ...
        points = model.points_MonteCarlo(batch_size, key, [{'patch': 'obj3', 'label': 'ds3', 'axis': 0, 'end': 0, 'n': batch_size}])
