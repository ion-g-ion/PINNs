...
def simmulation( nl = 16, N = [64,64], num_blocks = 1):
    ...
    result = scipy.optimize.minimize(loss_grad, x0 = w0.to_py(), method = 'BFGS', jac = True, tol = 1e-8, options = {'disp' : False, 'maxiter' : 400}, callback = lambda x: 1 )
