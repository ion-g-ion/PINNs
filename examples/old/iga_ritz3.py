...
class Model(pinns.PINN):
    ...
    def solution1(self, ws, x):
        ...
        v = ((1-x[...,0])*(1-x[...,1]))[...,None]
        w = self.neural_networks['u12'](ws['u12'],x[...,1][...,None])*((1+x[...,0] )*(1 - x[...,1]))[...,None] + self.neural_networks['u13'](ws['u13'],x[...,0][...,None])*((1-x[...,0])*(1+x[...,1] ))[...,None]
    ...
    def solution2(self, ws, x):
        ...
        w = self.neural_networks['u12'](ws['u12'],x[...,1][...,None])*((1- x[...,0])*(1 - x[...,1]))[...,None] + self.neural_networks['u23'](ws['u23'],x[...,0][...,None])*((1-x[...,0] )*(1+x[...,0] ))[...,None]
    ...
    def solution3(self, ws, x):
        ...
        w =  self.neural_networks['u13'](ws['u13'],x[...,0][...,None])*((1-x[...,0])*(1-x[...,1]))[...,None] + self.neural_networks['u23'](ws['u23'],x[...,1][...,None])*((1-x[...,1])*(1+x[...,1]))[...,None]
    ...
    def loss_pde(self, ws):
        ...
        lpde2 = 0.5*(self.mu0*self.mur)*jnp.dot(jnp.einsum('mi,mij,mj->m',grad2,self.points['K2'],grad2), self.points['ws'])   
        lpde3 = 0.5*self.mu0*jnp.dot(jnp.einsum('mi,mij,mj->m',grad3,self.points['K3'],grad3), self.points['ws'])  
